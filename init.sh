...
echo '[MY_SCRIPT] Sway'
yay -S wayland polkit sway swaybg swaylock swayimg-git swaylock-effects-git swayidle-git waybar-git wl-clipboard-git otf-font-awesome mako-git grim-git slurp-git
